...
<html lang="en">
  ...
  <body style="background-color: #ccc;">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="about_us.html"  target="sbit">About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Contuct_us.html"  target="sbit">Contact Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#"  target="sbit">Terms And Condition</a>
            </li>
            <li class="nav-item">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 bg-light"><br>
          ...
          <div class="list-group">
            ...
            <a href="product_information.html" target="sbit"  style="text-decoration: none">
            <button type="button" class="list-group-item list-group-item-action">Product Information</button></a>
             <a href="customerInformation.html" target="sbit"  style="text-decoration: none">
            <button type="button" class="list-group-item list-group-item-action">Customer Information</button></a>
             <a href="Create_user.html" target="sbit"  style="text-decoration: none">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 bg-light">footer</div>
      </div>
