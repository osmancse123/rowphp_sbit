...
<html lang="en">
  ...
  <tbody>
    <tr>
     ...
     <tr>
      <td>Category ID</td>
      <td><input type="text" name="id" value="<?php echo $fetcharry[2]; ?>" class="form-control"></td>
    </tr>

     <tr>
      <td>Category Name</td>
      <td><input type="text" name="name" value="<?php echo $fetcharry[3]; ?>" class="form-control"></td>
    </tr>
    <tr>
